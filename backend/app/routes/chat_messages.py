...
@chat_messages_bp.post("/sessions/<uuid:session_id>/chat-messages")
def create_chat_message(session_id):
    ...
    message = append_cached_message(session_id, role, content)
...
@chat_messages_bp.get("/sessions/<uuid:session_id>/chat-messages")
...
@chat_messages_bp.post("/sessions/<uuid:session_id>/chat-messages/flush")
